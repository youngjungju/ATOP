  ...
  return (
    <FadeInCard delay={0.1}>
      <div className="flex justify-between items-start mb-6">
        <h2 className="text-sm font-bold text-gray-400 uppercase tracking-tight">{t.diagnosisSummary.title}</h2>
      ...
      <div className="flex justify-center items-center gap-6 mb-4">
        <div className="flex flex-col items-center gap-2">
          <div className="w-20 h-20 rounded-full border-4 border-[#4A90E2]/20 overflow-hidden relative bg-gray-200">
            {imageUrl ? (
              <img src={imageUrl} alt={t.diagnosisSummary.userPhoto} className="w-full h-full object-cover" />
            ) : (
          ...
          <span className="text-[10px] font-bold text-gray-400 uppercase">{t.diagnosisSummary.userPhoto}</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-[10px] font-bold text-gray-400 uppercase">{t.diagnosisSummary.reference}</span>
        </div>
      </div>
    </FadeInCard>
  );
